        ...
        <tr>
            ...
            <td>
                Estatus: 
                    ...
                    ?><br>
                Creada: <?= h($evaluation->sale->created) ?><br>
            ...
            <td class="actions">
                <?= $this->Html->link(__('<i class="fas fw fa-eye"></i>'), ['controller'=>'evaluations','action' => 'view', $evaluation->id], ['title' => __('View'), 'class' => 'btn btn-secondary','escape' => false ]) ?>
