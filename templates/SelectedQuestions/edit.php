...
<li><?= $this->Form->postLink(__('Eliminar'), ['action' => 'delete', $selectedQuestion->id], ['confirm' => __('Are you sure you want to delete # {0}?', $selectedQuestion->id), 'class' => 'nav-link']) ?></li>
...
<div class="selectedQuestions form content">
    ...
    <fieldset>
        <legend><?= __('Edit Selected Question') ?></legend>
        <?php
